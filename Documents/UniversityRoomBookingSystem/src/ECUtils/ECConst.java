...
public class ECConst {
	...
	{   
		...
		"insert into staff(user_name, pass) values ('admin', 'admin@123')",	
                "create table booking_detail (id INT NOT NULL AUTO_INCREMENT, lec_name varchar(45),email varchar(20),  time varchar(20), duration varchar(30),date varchar(30),type_of_room varchar(20),room_no varchar(20),attendee_no varchar(20),reason_for_booking varchar(500),status varchar(20),booking_id varchar(20),room_cap varchar(20), phone_no varchar(20),address varchar(500), PRIMARY KEY (id))",
