...
public class ECConst {
	...
	{   
		...
		"insert into staff(user_name, pass) values ('admin', 'admin@123')",	
                "create table client (id INT NOT NULL AUTO_INCREMENT, client_name varchar(45), pass varchar(45), pt_name varchar(45),email varchar(20),  time varchar(20), duration varchar(30), focus varchar(40),date varchar(30),  PRIMARY KEY (id))",
